...
public class MainControllerTest {
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                .andDo(print())
                .andExpect(authenticated())
                .andExpect(xpath("//section[@id='message-list']/div").nodeCount(5))
                .andExpect(xpath("//section[@id='message-list']/div[@data-id=10]").exists())
                .andExpect(xpath("//section[@id='message-list']/div[@data-id=10]/div/span").string("fifth"))
                .andExpect(xpath("//section[@id='message-list']/div[@data-id=10]/div/i").string("#new one"));
    }
